...
function Input({ className, error, errorMessage, ...props }: InputProps, ref: LegacyRef<HTMLInputElement> | undefined) {
  // tw-merge (talwind-merge) é usado para o css não ser mudado caso for acrescentado mudanças na renderização do componente
  ...
  return (
    <div className="flex w-full flex-col">
      {/* ref serve para usar o react hook form */}
